...
.PHONY: all java-common java-8 java-8-appdynamics java-10 java-10-appdynamics java-11 java-11-appdynamics java-12 java-12-appdynamics java-13 java-13-appdynamics java-14 java-14-appdynamics java-15 java-15-appdynamics wildfly-17 common node-express-9 node-express-12 node-express-14 python-38 python-37

all: java-8 java-8-appdynamics java-10 java-10-appdynamics java-11 java-11-appdynamics java-12 java-12-appdynamics java-13 java-13-appdynamics java-14 java-14-appdynamics java-15 java-15-appdynamics wildfly-17 node-express-9 node-express-12 node-express-14 python-38 python-37
...
node-express-9: common
	docker build --pull -t navikt/node-express:9-common node-express-9
node-express-12: common
	docker build --pull -t navikt/node-express:12.18-alpine node-express-12
node-express-14: common
	docker build --pull -t navikt/node-express:14-alpine node-express-14
